...
const query_schema = z.object({
    ...
    search_type: z.optional(z.string())
})
...
export async function GET(req: NextRequest) {
	...
	}${process.env.NEXT_PUBLIC_PREFIX ? process.env.NEXT_PUBLIC_PREFIX : ""}/api/knowledge_graph/search_properties`;
		

	const test_properties = await (await fetch(url)).json();
